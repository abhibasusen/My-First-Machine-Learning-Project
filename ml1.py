# -*- coding: utf-8 -*-
"""
Created on Thu Jul 05 21:58:18 2018
...
def extract_featuresets(ticker):
    ...
    df['{}_target'.format(ticker)]=list(map(buy_sell_hold,df['{}_1d'.format(ticker)],
                                                   df['{}_2d'.format(ticker)],df['{}_3d'.format(ticker)],df['{}_4d'.format(ticker)],df['{}_5d'.format(ticker)],df['{}_6d'.format(ticker)],df['{}_7d'.format(ticker)]))
...
def do_ml(ticker):
    ...
    print ('Predicted Spread:', collections.Counter(predictions))
    return (confidence)
do_ml('ZEEL')